        ...
        <div style={{ fontSize: "13px", width: "100%" }}>
          ...
          >
            ...
            >
              ...
              <Text strong style={{ color: "#4e5969", fontSize: "14px" }}>
                {t('nodes.wechat_work.inputs.recipient.title')}
              </Text>
            </div>
            <Field name="inputsValues.recipient">
              {({ field }) => {
                ...
                return (
                  ...
                  >
                    {isEmpty ? (
                      ...
                      >
                        {t('nodes.wechat_work.form.noRecipients')}
                      </div>
                    ) : recipients.length > 3 ? (
                      [
                        ...
                        <div
                          ...
                          title={t('nodes.wechat_work.form.moreRecipients', { count: recipients.length - 2 })}
                        >
                          +{recipients.length - 2}
                        </div>,
                      ]
          ...
          >
            ...
            >
              ...
              <Text strong>{t('nodes.wechat_work.inputs.subject.title')}</Text>
            </div>
            ...
            <Field name="inputsValues.subject">
              {({ field }) => {
                ...
                return isEmpty ? (
                  ...
                  >
                    {t('nodes.wechat_work.form.noSubject')}
                  </div>
                ) : (
                  <div
                    style={{
          ...
          >
            ...
            >
              ...
              <Text strong>{t('nodes.wechat_work.inputs.content.title')}</Text>
            </div>
            ...
            <Field name="inputsValues.content">
              {({ field }) => {
                ...
                return isEmpty ? (
                  ...
                  >
                    {t('nodes.wechat_work.form.noContent')}
                  </div>
                ) : (
                  <div
                    style={{
        ...
        <div style={{ padding: 12 }}>
          ...
          <Field
            ...
            >) => {
              ...
              return (
                <FormItem
                  name={t('nodes.wechat_work.inputs.recipient.title')}
                  type="string"
                  required={true}
                  isColumn={true}
                  labelWidth={70}
                >
                  <FxExpression
                    ...
                    useTextArea={true}
                    rows={4}
                    placeholder={t('nodes.wechat_work.inputs.recipient.description')}
                    form={form}
                    fieldPath="inputsValues.recipient"
                  />
                  <Feedback
          ...
          <Field
            ...
            >) => {
              ...
              return (
                <FormItem
                  name={t('nodes.wechat_work.inputs.subject.title')}
                  type="string"
                  required={true}
                  isColumn={true}
                  labelWidth={60}
                >
                  <FxExpression
                    ...
                    hasError={Object.keys(fieldState?.errors || {}).length > 0}
                    readonly={readonly}
                    placeholder={t('nodes.wechat_work.form.subjectPlaceholder')}
                    form={form}
          ...
          <Field
            ...
            >) => {
              ...
              return (
                <FormItem
                  name={t('nodes.wechat_work.inputs.content.title')}
                  type="string"
                  required={true}
                  isColumn={true}
                  labelWidth={60}
                >
                  <FxExpression
                    ...
                    useTextArea={true}
                    rows={6}
                    placeholder={t('nodes.wechat_work.form.contentPlaceholder')}
                    form={form}
...
export const formMeta: FormMeta<FlowNodeJSON> = {
  ...
  validate: {
    title: ({ value }: { value: string }) => (value ? undefined : t('nodes.wechat_work.validation.titleRequired')),
    "inputsValues.recipient": ({ value }) => {
      if (typeof value === "string" && value.trim() === "") {
        return t('nodes.wechat_work.validation.recipientRequired');
      }
      if (
        typeof value === "object" &&
        value.type === "expression" &&
    ...
    "inputsValues.subject": ({ value }) => {
      if (typeof value === "string" && value.trim() === "") {
        return t('nodes.wechat_work.validation.subjectRequired');
      }
      if (
        typeof value === "object" &&
        value.type === "expression" &&
    ...
    "inputsValues.content": ({ value }) => {
      if (typeof value === "string" && value.trim() === "") {
        return t('nodes.wechat_work.validation.contentRequired');
      }
      if (
        typeof value === "object" &&
        value.type === "expression" &&
